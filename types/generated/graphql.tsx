...
export type Mutation_Root = {
  ...
  update_profiles_users_many?: Maybe<
    Array<Maybe<Profiles_Users_Mutation_Response>>
  >
...
export type Mutation_RootInsert_Profiles_UsersArgs = {
  ...
  on_conflict?: Maybe<Profiles_Users_On_Conflict>
}
...
export type Mutation_RootUpdate_Profiles_UsersArgs = {
  _set?: Maybe<Profiles_Users_Set_Input>
  where: Profiles_Users_Bool_Exp
}
...
export type ProfilesProfiles_UsersArgs = {
  distinct_on?: Maybe<Array<Profiles_Users_Select_Column>>
  limit?: Maybe<Scalars['Int']>
  offset?: Maybe<Scalars['Int']>
  order_by?: Maybe<Array<Profiles_Users_Order_By>>
  where?: Maybe<Profiles_Users_Bool_Exp>
}
...
export type Profiles_Bool_Exp = {
  ...
  profiles_users?: Maybe<Profiles_Users_Bool_Exp>
  profiles_users_aggregate?: Maybe<Profiles_Users_Aggregate_Bool_Exp>
...
export type Profiles_Insert_Input = {
  ...
  profiles_users?: Maybe<Profiles_Users_Arr_Rel_Insert_Input>
...
export type Profiles_Order_By = {
  ...
  profiles_users_aggregate?: Maybe<Profiles_Users_Aggregate_Order_By>
...
export type Profiles_Users_Aggregate_Bool_Exp = {
  count?: Maybe<Profiles_Users_Aggregate_Bool_Exp_Count>
}

export type Profiles_Users_Aggregate_Bool_Exp_Count = {
  arguments?: Maybe<Array<Profiles_Users_Select_Column>>
  distinct?: Maybe<Scalars['Boolean']>
  filter?: Maybe<Profiles_Users_Bool_Exp>
...
export type Profiles_Users_Aggregate_FieldsCountArgs = {
  columns?: Maybe<Array<Profiles_Users_Select_Column>>
  distinct?: Maybe<Scalars['Boolean']>
}
...
export type Profiles_Users_Aggregate_Order_By = {
  ...
  max?: Maybe<Profiles_Users_Max_Order_By>
  min?: Maybe<Profiles_Users_Min_Order_By>
}
...
export type Profiles_Users_Bool_Exp = {
  _and?: Maybe<Array<Profiles_Users_Bool_Exp>>
  _not?: Maybe<Profiles_Users_Bool_Exp>
  _or?: Maybe<Array<Profiles_Users_Bool_Exp>>
  id?: Maybe<Uuid_Comparison_Exp>
...
/** Streaming cursor of the table "profiles_users" */
export type Profiles_Users_Stream_Cursor_Input = {
  /** Stream column input with initial value */
  initial_value: Profiles_Users_Stream_Cursor_Value_Input
  /** cursor ordering */
  ordering?: Maybe<Cursor_Ordering>
}

/** Initial value of the column from where the streaming should start */
export type Profiles_Users_Stream_Cursor_Value_Input = {
  id?: Maybe<Scalars['uuid']>
  profile_id?: Maybe<Scalars['uuid']>
  user_id?: Maybe<Scalars['uuid']>
}
...
export type Subscription_Root = {
  ...
  /** fetch data from the table: "profiles_users" using primary key columns */
  profiles_users_by_pk?: Maybe<Profiles_Users>
  /** fetch data from the table in a streaming manner: "profiles_users" */
  profiles_users_stream: Array<Profiles_Users>
  /** An array relationship */
  users: Array<Users>
  /** An aggregate relationship */
  users_aggregate: Users_Aggregate
...
export type Subscription_RootProfiles_Users_StreamArgs = {
  batch_size: Scalars['Int']
  cursor: Array<Maybe<Profiles_Users_Stream_Cursor_Input>>
  where?: Maybe<Profiles_Users_Bool_Exp>
}
...
// __typenameはフィールド名が入る
// __typename?: 'query_root'はrootに定義されているからrootになる
// __typename: usersはusers層にあることを示している
